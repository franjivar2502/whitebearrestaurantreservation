  ...
  const DICTIONARIES = {
    en: {
      ...
      errors: {
        ...
        NO_AVAILABILITY: "We don't have availability for that date and time with that party size. Please try another time or call us.",
    ...
    es: {
      ...
      form: {
        ...
        occasionOther: "Otro",
        seating: "Ubicación de mesa (opcional)",
      ...
      errors: {
        ...
        NO_AVAILABILITY: "No tenemos disponibilidad para esa fecha y hora con ese número de personas. Prueba otro horario o llámanos.",
    ...
    fr: {
      ...
      form: {
        ...
        occasionOther: "Autre",
        seating: "Emplacement (facultatif)",
        seatingNone: "Aucune préférence",
        seatingInside: "Intérieur",
        seatingOutside: "Extérieur",
      ...
      errors: {
        ...
        NO_AVAILABILITY: "Nous n'avons pas de disponibilité pour cette date et cette heure avec ce nombre de personnes. Essayez un autre horaire ou appelez-nous.",
